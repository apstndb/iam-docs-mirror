---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients/credentials/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients/credentials/delete
title: gcloud alpha iam oauth-clients credentials delete
...
gcloud alpha iam oauth-clients credentials delete - delete an OAuth client credential

SYNOPSIS

`gcloud alpha iam oauth-clients credentials delete` ( `  CREDENTIAL  ` : `  --location  ` = `  LOCATION  ` `  --oauth-client  ` = `  OAUTH_CLIENT  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To delete the OAuth client credential with ID `  my-oauth-client-credential  ` in the default project, run:
    ...
    gcloud alpha iam oauth-clients credentials delete my-oauth-client-credential --location="global" --oauth-client="my-oauth-client"

POSITIONAL ARGUMENTS

Oauth client credential resource - The OAuth client credential to delete. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways.
