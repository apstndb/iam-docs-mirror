---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients/credentials/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients/credentials/update
title: gcloud alpha iam oauth-clients credentials update
...
gcloud alpha iam oauth-clients credentials update - update an OAuth client credential

SYNOPSIS

`gcloud alpha iam oauth-clients credentials update` ( `  CREDENTIAL  ` : `  --location  ` = `  LOCATION  ` `  --oauth-client  ` = `  OAUTH_CLIENT  ` ) \[ `  --disabled  ` \] \[ `  --display-name  ` = `  DISPLAY_NAME  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To update the OAuth client credential with ID `  my-oauth-client-credential  ` in the default project, run:

    gcloud alpha iam oauth-clients credentials update my-oauth-client-credential --location="global" --oauth-client="my-oauth-client" --display-name="My OAuth client credential" --disabled

POSITIONAL ARGUMENTS

Oauth client credential resource - The OAuth client credential to update. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways.
