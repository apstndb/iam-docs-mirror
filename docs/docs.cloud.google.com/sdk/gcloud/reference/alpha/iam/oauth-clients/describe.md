---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients/describe
title: gcloud alpha iam oauth-clients describe
...
`gcloud alpha iam oauth-clients describe` ( `  OAUTH_CLIENT  ` : `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
The following command describes the OAuth client with the ID `  my-oauth-client  ` in the default project:
    ...
    gcloud alpha iam oauth-clients describe my-oauth-client --location="global"
