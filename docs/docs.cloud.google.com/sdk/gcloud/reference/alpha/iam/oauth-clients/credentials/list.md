---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients/credentials/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients/credentials/list
title: gcloud alpha iam oauth-clients credentials list
...
gcloud alpha iam oauth-clients credentials list - list OAuth client credentials

SYNOPSIS

`gcloud alpha iam oauth-clients credentials list` ( `  --oauth-client  ` = `  OAUTH_CLIENT  ` : `  --location  ` = `  LOCATION  ` ) \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To list all OAuth client credentials in the default project, run:
    ...
    gcloud alpha iam oauth-clients credentials list --location="global" --oauth-client="my-oauth-client"
