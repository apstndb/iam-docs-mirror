---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients/create
title: gcloud alpha iam oauth-clients create
...
`(ALPHA)` Create a new OAuth client.

EXAMPLES

The following command creates a disabled OAuth client with ID `  my-oauth-client  ` in the default project:

    gcloud alpha iam oauth-clients create my-oauth-client --location="global" --client-type="confidential-client" --display-name="My oauth client" --description="My oauth client description" --disabled --allowed-grant-types="authorization-code-grant,refresh-token-grant" --allowed-scopes="https://www.googleapis.com/auth/cloud-platform\,openid" --allowed-redirect-uris="https://example.com"
