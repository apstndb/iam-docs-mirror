---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/oauth-clients
title: gcloud alpha iam oauth-clients
...
`(ALPHA)` The gcloud alpha iam oauth-clients group lets you create and manage OAuth clients for projects on the Google Cloud Platform.
