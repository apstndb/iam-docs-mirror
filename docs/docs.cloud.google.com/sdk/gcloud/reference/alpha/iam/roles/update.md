---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/roles/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/roles/update
title: gcloud alpha iam roles update
...
To update the role `  ProjectUpdater  ` from a YAML file, run:
    ...
    gcloud alpha iam roles update ProjectUpdater --organization=123 --file=role_file_path

To update the role `  ProjectUpdater  ` with flags, run:

    gcloud alpha iam roles update ProjectUpdater --project=myproject --permissions=permission1,permission2
