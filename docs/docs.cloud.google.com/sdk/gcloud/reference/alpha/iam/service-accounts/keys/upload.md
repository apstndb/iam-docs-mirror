---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/service-accounts/keys/upload
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/service-accounts/keys/upload
title: gcloud alpha iam service-accounts keys upload
...
The following command uploads a public key certificate to a service account:
    ...
    gcloud alpha iam service-accounts keys upload test_data/public_key.cert --iam-account=my-iam-account@my-project.iam.gserviceaccount.com
...
IamAccount resource - The service account for which to upload a key. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways.
