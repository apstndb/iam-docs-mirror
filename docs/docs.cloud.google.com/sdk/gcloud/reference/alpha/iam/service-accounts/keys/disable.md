---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/service-accounts/keys/disable
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/service-accounts/keys/disable
title: gcloud alpha iam service-accounts keys disable
...
gcloud alpha iam service-accounts keys disable - disable a service account key

SYNOPSIS

`gcloud alpha iam service-accounts keys disable` ( `  IAM_KEY  ` : `  --iam-account  ` = `  IAM_ACCOUNT  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To disable a key with ID `b4f1037aeef9ab37deee9` for the service account `my-iam-account@my-project.iam.gserviceaccount.com` , run:
    ...
    gcloud alpha iam service-accounts keys disable b4f1037aeef9ab37deee9 --iam-account=my-iam-account@my-project.iam.gserviceaccount.com
