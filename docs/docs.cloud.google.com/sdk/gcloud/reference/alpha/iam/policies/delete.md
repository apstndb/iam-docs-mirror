---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/policies/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/policies/delete
title: gcloud alpha iam policies delete
...
`gcloud alpha iam policies delete` `  POLICY_ID  ` `  --attachment-point  ` = `  ATTACHMENT_POINT  ` `  --kind  ` = `  KIND  ` \[ `  --etag  ` = `  ETAG  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
