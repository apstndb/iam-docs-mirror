---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/workload-identity-pools/providers
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/workload-identity-pools/providers
title: gcloud alpha iam workload-identity-pools providers
...
gcloud alpha iam workload-identity-pools providers - manage IAM workload identity pool providers

SYNOPSIS

`gcloud alpha iam workload-identity-pools providers` `  GROUP  ` | `  COMMAND  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
`  GROUP  ` is one of the following:
  ...
  - `  operations  `  
    `(ALPHA)` Manage IAM workload identity pool provider long running operations.
