---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/workforce-pools/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/workforce-pools/describe
title: gcloud alpha iam workforce-pools describe
...
gcloud alpha iam workforce-pools describe - describe a workforce pool

SYNOPSIS

`gcloud alpha iam workforce-pools describe` ( `  WORKFORCE_POOL  ` : `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
The following command describes a workforce pool with ID `  my-workforce-pool  ` :
    ...
    gcloud alpha iam workforce-pools describe my-workforce-pool --location=global
