---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/workforce-pools/undelete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/workforce-pools/undelete
title: gcloud alpha iam workforce-pools undelete
...
gcloud alpha iam workforce-pools undelete - undelete a workforce pool

SYNOPSIS

`gcloud alpha iam workforce-pools undelete` ( `  WORKFORCE_POOL  ` : `  --location  ` = `  LOCATION  ` ) \[ `  --async  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
The following command undeletes a workforce pool with ID `  my-workforce-pool  ` :
    ...
    gcloud alpha iam workforce-pools undelete my-workforce-pool --location=global
