---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/workforce-pools/operations/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/iam/workforce-pools/operations/describe
title: gcloud alpha iam workforce-pools operations describe
...
gcloud alpha iam workforce-pools operations describe - describe a workforce pool operation

SYNOPSIS

`gcloud alpha iam workforce-pools operations describe` ( `  OPERATION  ` : `  --location  ` = `  LOCATION  ` `  --workforce-pool  ` = `  WORKFORCE_POOL  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]

DESCRIPTION

`(ALPHA)` Describe a workforce pool operation.

EXAMPLES

To describe the long-running workforce pool operation with the ID `  my-operation  ` , run:

    gcloud alpha iam workforce-pools operations describe my-operation --workforce-pool="my-workforce-pool" --location="global"
