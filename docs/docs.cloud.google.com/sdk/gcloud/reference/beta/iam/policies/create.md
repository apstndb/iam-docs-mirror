---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/policies/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/policies/create
title: gcloud beta iam policies create
...
gcloud beta iam policies create - create a policy on the given attachment point with the given name
...
The following command creates the IAM policy defined at the resource project `  123  ` of kind `  denypolicies  ` and id `  my-deny-policy  ` from the file `  policy.json  ` :
    ...
    gcloud beta iam policies create my-deny-policy --attachment-point=cloudresourcemanager.googleapis.com/projects/123 --kind=denypolicies --policy-file=policy.json
