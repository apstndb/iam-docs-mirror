---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/access-policies/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/access-policies/describe
title: gcloud beta iam access-policies describe
...
To get the details of a single policy `my-policy` in organization `123` , run:
    ...
    gcloud beta iam access-policies describe my-policy --organization=123 --location=global
