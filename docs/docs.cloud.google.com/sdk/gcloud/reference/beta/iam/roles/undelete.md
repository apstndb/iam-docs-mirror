---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/roles/undelete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/roles/undelete
title: gcloud beta iam roles undelete
...
`(BETA)` This command undeletes a role. Roles that have been deleted for certain long time can't be undeleted.
