---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/service-accounts/get-iam-policy
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/service-accounts/get-iam-policy
title: gcloud beta iam service-accounts get-iam-policy
...
To print the IAM policy for a given service account, run:
    ...
    gcloud beta iam service-accounts get-iam-policy my-iam-account@my-project.iam.gserviceaccount.com
