---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/service-accounts/keys/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/service-accounts/keys/create
title: gcloud beta iam service-accounts keys create
...
gcloud beta iam service-accounts keys create - create a service account key
...
To create a new service account key and save the private portion of the key locally, run:
    ...
    gcloud beta iam service-accounts keys create key.json --iam-account=my-iam-account@my-project.iam.gserviceaccount.com
