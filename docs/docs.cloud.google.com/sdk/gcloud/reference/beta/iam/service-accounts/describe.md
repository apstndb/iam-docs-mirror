---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/service-accounts/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/service-accounts/describe
title: gcloud beta iam service-accounts describe
...
`gcloud beta iam service-accounts describe` `  SERVICE_ACCOUNT  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To print metadata for a service account from your project, run:
    ...
    gcloud beta iam service-accounts describe my-iam-account@my-project.iam.gserviceaccount.com
