---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workload-identity-pools
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workload-identity-pools
title: gcloud beta iam workload-identity-pools
...
gcloud beta iam workload-identity-pools - manage IAM workload identity pools

SYNOPSIS

`gcloud beta iam workload-identity-pools` `  GROUP  ` | `  COMMAND  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
