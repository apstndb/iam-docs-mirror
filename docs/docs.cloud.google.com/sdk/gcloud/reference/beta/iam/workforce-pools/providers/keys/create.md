---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workforce-pools/providers/keys/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workforce-pools/providers/keys/create
title: gcloud beta iam workforce-pools providers keys create
...
The following command creates a workforce pool provider key with the ID `  my-key  ` . Explicit values for all required and optional parameters are provided.
    ...
    gcloud beta iam workforce-pools providers keys create my-key --location="global" --workforce-pool="my-workforce-pool" --provider="my-provider" --use="ENCRYPTION" --spec="RSA_4096"
