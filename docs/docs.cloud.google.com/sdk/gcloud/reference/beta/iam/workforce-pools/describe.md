---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workforce-pools/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workforce-pools/describe
title: gcloud beta iam workforce-pools describe
...
gcloud beta iam workforce-pools describe - describe a workforce pool

SYNOPSIS

`gcloud beta iam workforce-pools describe` ( `  WORKFORCE_POOL  ` : `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
The following command describes a workforce pool with ID `  my-workforce-pool  ` :
    ...
    gcloud beta iam workforce-pools describe my-workforce-pool --location=global
