---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workforce-pools/operations/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workforce-pools/operations/describe
title: gcloud beta iam workforce-pools operations describe
...
gcloud beta iam workforce-pools operations describe - describe a workforce pool operation

SYNOPSIS

`gcloud beta iam workforce-pools operations describe` ( `  OPERATION  ` : `  --location  ` = `  LOCATION  ` `  --workforce-pool  ` = `  WORKFORCE_POOL  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]

DESCRIPTION

`(BETA)` Describe a workforce pool operation.

EXAMPLES

To describe the long-running workforce pool operation with the ID `  my-operation  ` , run:

    gcloud beta iam workforce-pools operations describe my-operation --workforce-pool="my-workforce-pool" --location="global"
