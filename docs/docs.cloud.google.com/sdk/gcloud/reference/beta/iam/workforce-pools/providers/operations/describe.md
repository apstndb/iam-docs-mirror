---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workforce-pools/providers/operations/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workforce-pools/providers/operations/describe
title: gcloud beta iam workforce-pools providers operations describe
...
gcloud beta iam workforce-pools providers operations describe - describe a workforce pool provider operation

SYNOPSIS

`gcloud beta iam workforce-pools providers operations describe` ( `  OPERATION  ` : `  --location  ` = `  LOCATION  ` `  --provider  ` = `  PROVIDER  ` `  --workforce-pool  ` = `  WORKFORCE_POOL  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]

DESCRIPTION

`(BETA)` Describe a workforce pool provider operation.

EXAMPLES

To describe the long-running workforce pool provider operation with the ID `  my-operation  ` , run:

    gcloud beta iam workforce-pools providers operations describe my-operation --workforce-pool="my-workforce-pool" --provider="my-provider" --location="global"
