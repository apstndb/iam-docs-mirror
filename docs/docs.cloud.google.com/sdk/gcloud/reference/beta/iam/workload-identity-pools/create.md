---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workload-identity-pools/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workload-identity-pools/create
title: gcloud beta iam workload-identity-pools create
...
The following command creates a disabled workload identity pool in the default project with the ID `  my-workload-identity-pool  ` . Explicit values for all required and optional parameters are provided.
    ...
    gcloud beta iam workload-identity-pools create my-workload-identity-pool --location="global" --display-name="My workload pool" --description="My workload pool description" --disabled
