---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workload-identity-pools/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workload-identity-pools/list
title: gcloud beta iam workload-identity-pools list
...
`gcloud beta iam workload-identity-pools list` `  --location  ` = `  LOCATION  ` \[ `  --show-deleted  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
The following command lists all workload identity pools in the default project, including soft-deleted pools:
    ...
    gcloud beta iam workload-identity-pools list --location="global" --show-deleted
