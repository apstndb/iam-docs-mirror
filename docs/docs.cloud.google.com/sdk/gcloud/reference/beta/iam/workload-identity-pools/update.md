---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workload-identity-pools/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/workload-identity-pools/update
title: gcloud beta iam workload-identity-pools update
...
gcloud beta iam workload-identity-pools update - update a workload identity pool

SYNOPSIS

`gcloud beta iam workload-identity-pools update` ( `  WORKLOAD_IDENTITY_POOL  ` : `  --location  ` = `  LOCATION  ` ) \[ `  --description  ` = `  DESCRIPTION  ` \] \[ `  --disabled  ` \] \[ `  --display-name  ` = `  DISPLAY_NAME  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
The following command updates the workload identity pool with the ID `  my-workload-identity-pool  ` :
    ...
    gcloud beta iam workload-identity-pools update my-workload-identity-pool --location="global" --display-name="My workload pool" --description="My workload pool description" --disabled
