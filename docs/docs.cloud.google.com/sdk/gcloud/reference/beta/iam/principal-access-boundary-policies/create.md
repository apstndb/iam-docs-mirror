---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/iam/principal-access-boundary-policies/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/iam/principal-access-boundary-policies/create
title: gcloud beta iam principal-access-boundary-policies create
...
To create a policy instance called `my-policy` , run:
    ...
    gcloud beta iam principal-access-boundary-policies create my-policy --organization=123 --location=global
