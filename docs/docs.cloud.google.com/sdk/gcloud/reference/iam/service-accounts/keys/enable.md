---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/service-accounts/keys/enable
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/service-accounts/keys/enable
title: gcloud iam service-accounts keys enable
...
`gcloud iam service-accounts keys enable` ( `  IAM_KEY  ` : `  --iam-account  ` = `  IAM_ACCOUNT  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
