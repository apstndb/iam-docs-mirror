---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/policy-bindings/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/policy-bindings/describe
title: gcloud iam policy-bindings describe
...
`gcloud iam policy-bindings describe` ( `  POLICY_BINDING  ` : `  --folder  ` = `  FOLDER  ` `  --location  ` = `  LOCATION  ` `  --organization  ` = `  ORGANIZATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
