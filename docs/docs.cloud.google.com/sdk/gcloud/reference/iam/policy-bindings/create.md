---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/policy-bindings/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/policy-bindings/create
title: gcloud iam policy-bindings create
