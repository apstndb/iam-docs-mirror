---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/policy-bindings/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/policy-bindings/delete
title: gcloud iam policy-bindings delete
