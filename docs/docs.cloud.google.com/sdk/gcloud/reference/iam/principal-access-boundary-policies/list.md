---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/principal-access-boundary-policies/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/principal-access-boundary-policies/list
title: gcloud iam principal-access-boundary-policies list
...
`gcloud iam principal-access-boundary-policies list` ( `  --location  ` = `  LOCATION  ` : `  --organization  ` = `  ORGANIZATION  ` ) \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
