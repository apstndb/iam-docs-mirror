---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/create-cred-config
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/create-cred-config
title: gcloud iam workforce-pools create-cred-config
...
This command creates a configuration file to allow access to authenticated Google Cloud actions from a variety of external user accounts.
