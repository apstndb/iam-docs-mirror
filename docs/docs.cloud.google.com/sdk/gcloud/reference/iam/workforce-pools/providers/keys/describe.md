---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/keys/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/keys/describe
title: gcloud iam workforce-pools providers keys describe
...
`gcloud iam workforce-pools providers keys describe` ( `  KEY  ` : `  --location  ` = `  LOCATION  ` `  --provider  ` = `  PROVIDER  ` `  --workforce-pool  ` = `  WORKFORCE_POOL  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
