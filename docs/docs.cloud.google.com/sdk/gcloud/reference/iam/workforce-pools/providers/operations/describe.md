---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/operations/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/operations/describe
title: gcloud iam workforce-pools providers operations describe
...
`gcloud iam workforce-pools providers operations describe` ( `  OPERATION  ` : `  --location  ` = `  LOCATION  ` `  --provider  ` = `  PROVIDER  ` `  --workforce-pool  ` = `  WORKFORCE_POOL  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
