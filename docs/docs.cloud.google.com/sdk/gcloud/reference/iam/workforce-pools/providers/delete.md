---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/delete
title: gcloud iam workforce-pools providers delete
...
`gcloud iam workforce-pools providers delete` ( `  PROVIDER  ` : `  --location  ` = `  LOCATION  ` `  --workforce-pool  ` = `  WORKFORCE_POOL  ` ) \[ `  --async  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
