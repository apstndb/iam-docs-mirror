---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/undelete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/undelete
title: gcloud iam workforce-pools providers undelete
...
`gcloud iam workforce-pools providers undelete` ( `  PROVIDER  ` : `  --location  ` = `  LOCATION  ` `  --workforce-pool  ` = `  WORKFORCE_POOL  ` ) \[ `  --async  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
The following command undeletes a workforce pool provider with the ID `my-workforce-pool-provider` :
    ...
    gcloud iam workforce-pools providers undelete my-workforce-pool-provider --workforce-pool="my-workforce-pool" --location="global"
