---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/keys/undelete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/keys/undelete
title: gcloud iam workforce-pools providers keys undelete
...
`gcloud iam workforce-pools providers keys undelete` ( `  KEY  ` : `  --location  ` = `  LOCATION  ` `  --provider  ` = `  PROVIDER  ` `  --workforce-pool  ` = `  WORKFORCE_POOL  ` ) \[ `  --async  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
