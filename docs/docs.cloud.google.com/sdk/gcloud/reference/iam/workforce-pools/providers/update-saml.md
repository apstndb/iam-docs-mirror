---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/update-saml
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/update-saml
title: gcloud iam workforce-pools providers update-saml
...
The following command updates the SAML workforce pool provider with the ID `my-workforce-pool-provider` . Explicit values for all required and optional parameters are provided.

    gcloud iam workforce-pools providers update-saml my-workforce-pool-provider --workforce-pool="my-workforce-pool" --location="global" --display-name="My Workforce Pool Provider" --description="My workforce pool provider description." --disabled --detailed-audit-logging --attribute-mapping="google.subject=assertion.sub" --attribute-condition="true" --idp-metadata-path="path/to/metdata/file.xml"
