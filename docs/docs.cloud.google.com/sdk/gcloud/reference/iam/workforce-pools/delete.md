---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/delete
title: gcloud iam workforce-pools delete
...
`gcloud iam workforce-pools delete` ( `  WORKFORCE_POOL  ` : `  --location  ` = `  LOCATION  ` ) \[ `  --async  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
