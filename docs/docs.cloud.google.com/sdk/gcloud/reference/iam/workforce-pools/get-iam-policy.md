---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/get-iam-policy
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/get-iam-policy
title: gcloud iam workforce-pools get-iam-policy
...
`gcloud iam workforce-pools get-iam-policy` ( `  WORKFORCE_POOL  ` : `  --location  ` = `  LOCATION  ` ) \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  GCLOUD_WIDE_FLAG …  ` \]
