---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/list
title: gcloud iam workforce-pools list
...
`gcloud iam workforce-pools list` `  --location  ` = `  LOCATION  ` `  --organization  ` = `  ORGANIZATION  ` \[ `  --show-deleted  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  GCLOUD_WIDE_FLAG …  ` \]

DESCRIPTION

Lists all of the workforce pools for an organization given a valid organization ID.
