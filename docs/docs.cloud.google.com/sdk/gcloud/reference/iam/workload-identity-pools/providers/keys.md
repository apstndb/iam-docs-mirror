---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/keys
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/keys
title: gcloud iam workload-identity-pools providers keys
...
`gcloud iam workload-identity-pools providers keys` `  GROUP  ` | `  COMMAND  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
