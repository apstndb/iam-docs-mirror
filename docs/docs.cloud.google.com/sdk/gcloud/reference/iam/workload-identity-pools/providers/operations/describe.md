---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/operations/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/operations/describe
title: gcloud iam workload-identity-pools providers operations describe
...
`gcloud iam workload-identity-pools providers operations describe` ( `  OPERATION  ` : `  --location  ` = `  LOCATION  ` `  --provider  ` = `  PROVIDER  ` `  --workload-identity-pool  ` = `  WORKLOAD_IDENTITY_POOL  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
