---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/undelete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/undelete
title: gcloud iam workload-identity-pools providers undelete
...
`gcloud iam workload-identity-pools providers undelete` ( `  PROVIDER  ` : `  --location  ` = `  LOCATION  ` `  --workload-identity-pool  ` = `  WORKLOAD_IDENTITY_POOL  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
