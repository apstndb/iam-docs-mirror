---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/delete
title: gcloud iam workload-identity-pools providers delete
...
`gcloud iam workload-identity-pools providers delete` ( `  PROVIDER  ` : `  --location  ` = `  LOCATION  ` `  --workload-identity-pool  ` = `  WORKLOAD_IDENTITY_POOL  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
