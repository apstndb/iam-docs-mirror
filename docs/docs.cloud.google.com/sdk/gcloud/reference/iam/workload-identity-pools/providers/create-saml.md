---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/create-saml
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/create-saml
title: gcloud iam workload-identity-pools providers create-saml
...
The following command creates a disabled SAML workload identity pool provider in the default project with the ID `  my-workload-identity-pool-provider  ` . Explicit values for all required and optional parameters are provided.
