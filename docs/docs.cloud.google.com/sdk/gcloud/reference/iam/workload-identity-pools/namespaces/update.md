---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/namespaces/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/namespaces/update
title: gcloud iam workload-identity-pools namespaces update
...
The following command updates the workload identity pool namespace with the ID my-namespace:
...
Workload identity pool namespace resource - The workload identity pool namespace to update. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways.
