---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/namespaces/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/namespaces/describe
title: gcloud iam workload-identity-pools namespaces describe
...
Workload identity pool namespace resource - The workload identity pool namespace to describe. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways.
