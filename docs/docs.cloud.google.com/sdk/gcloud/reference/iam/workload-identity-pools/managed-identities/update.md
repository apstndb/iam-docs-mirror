---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/managed-identities/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/managed-identities/update
title: gcloud iam workload-identity-pools managed-identities update
...
The following command updates the workload identity pool managed identity with the ID `my-managed-identity` :
...
Workload identity pool managed identity resource - Workload identity pool managed identity to update. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways.
