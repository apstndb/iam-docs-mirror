---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/undelete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/undelete
title: gcloud iam workload-identity-pools undelete
...
`gcloud iam workload-identity-pools undelete` ( `  WORKLOAD_IDENTITY_POOL  ` : `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
