---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/oauth-clients/credentials/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/oauth-clients/credentials/describe
title: gcloud iam oauth-clients credentials describe
...
`gcloud iam oauth-clients credentials describe` ( `  CREDENTIAL  ` : `  --location  ` = `  LOCATION  ` `  --oauth-client  ` = `  OAUTH_CLIENT  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
