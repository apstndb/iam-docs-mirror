---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/oauth-clients/credentials/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/oauth-clients/credentials/update
title: gcloud iam oauth-clients credentials update
...
`gcloud iam oauth-clients credentials update` ( `  CREDENTIAL  ` : `  --location  ` = `  LOCATION  ` `  --oauth-client  ` = `  OAUTH_CLIENT  ` ) \[ `  --disabled  ` \] \[ `  --display-name  ` = `  DISPLAY_NAME  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
