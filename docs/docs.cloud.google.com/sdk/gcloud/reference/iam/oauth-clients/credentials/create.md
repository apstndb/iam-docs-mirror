---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/oauth-clients/credentials/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/oauth-clients/credentials/create
title: gcloud iam oauth-clients credentials create
...
`gcloud iam oauth-clients credentials create` ( `  CREDENTIAL  ` : `  --location  ` = `  LOCATION  ` `  --oauth-client  ` = `  OAUTH_CLIENT  ` ) \[ `  --disabled  ` \] \[ `  --display-name  ` = `  DISPLAY_NAME  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
