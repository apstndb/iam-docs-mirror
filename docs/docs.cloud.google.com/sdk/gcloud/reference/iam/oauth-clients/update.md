---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/iam/oauth-clients/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/iam/oauth-clients/update
title: gcloud iam oauth-clients update
...
The following command updates the OAuth client with ID `  my-oauth-client  ` in the default project:
    ...
    gcloud iam oauth-clients update my-oauth-client --location="global" --display-name="My oauth client" --description="My oauth client description" --disabled --allowed-grant-types="authorization-code-grant,refresh-token-grant" --allowed-scopes="https://www.googleapis.com/auth/cloud-platform\,openid" --allowed-redirect-uris="http://localhost/"
