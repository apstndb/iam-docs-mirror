---
name: documents/docs.cloud.google.com/iam/docs/reference/rest/Shared.Types/Operation
uri: https://docs.cloud.google.com/iam/docs/reference/rest/Shared.Types/Operation
title: Operation
description: Fine-grained access control and visibility for centrally managing cloud resources.
data_source: docs.cloud.google.com
---

  - [JSON representation](https://docs.cloud.google.com/iam/docs/reference/rest/Shared.Types/Operation#SCHEMA_REPRESENTATION)
  - [Status](https://docs.cloud.google.com/iam/docs/reference/rest/Shared.Types/Operation#Status)
      - [JSON representation](https://docs.cloud.google.com/iam/docs/reference/rest/Shared.Types/Operation#Status.SCHEMA_REPRESENTATION)
