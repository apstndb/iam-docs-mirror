---
name: documents/docs.cloud.google.com/iam/docs/reference/mcp/tools_list/delete_role
uri: https://docs.cloud.google.com/iam/docs/reference/mcp/tools_list/delete_role
