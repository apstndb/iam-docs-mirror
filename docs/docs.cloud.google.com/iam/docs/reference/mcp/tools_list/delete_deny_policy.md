---
name: documents/docs.cloud.google.com/iam/docs/reference/mcp/tools_list/delete_deny_policy
uri: https://docs.cloud.google.com/iam/docs/reference/mcp/tools_list/delete_deny_policy
title: 'MCP Tools Reference: iam.googleapis.com'
description: Fine-grained access control and visibility for centrally managing cloud resources.
data_source: docs.cloud.google.com
---

## Tool: `delete_deny_policy`
...
The following code sample shows how to use `curl` to call the `delete_deny_policy` MCP tool.
