---
name: documents/docs.cloud.google.com/iam/docs/reference/mcp/tools_list/undelete_role
uri: https://docs.cloud.google.com/iam/docs/reference/mcp/tools_list/undelete_role
...
The following code sample shows how to use `curl` to call the `undelete_role` MCP tool.
