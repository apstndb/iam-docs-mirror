---
name: documents/docs.cloud.google.com/iam/docs/reference/sts/rest/v1beta/AccessBoundary
uri: https://docs.cloud.google.com/iam/docs/reference/sts/rest/v1beta/AccessBoundary
title: AccessBoundary
description: Fine-grained access control and visibility for centrally managing cloud resources.
data_source: docs.cloud.google.com
---

  - [JSON representation](https://docs.cloud.google.com/iam/docs/reference/sts/rest/v1beta/AccessBoundary#SCHEMA_REPRESENTATION)
  - [AccessBoundaryRule](https://docs.cloud.google.com/iam/docs/reference/sts/rest/v1beta/AccessBoundary#AccessBoundaryRule)
      - [JSON representation](https://docs.cloud.google.com/iam/docs/reference/sts/rest/v1beta/AccessBoundary#AccessBoundaryRule.SCHEMA_REPRESENTATION)
