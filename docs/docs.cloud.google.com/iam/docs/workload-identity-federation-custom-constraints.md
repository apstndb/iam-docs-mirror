---
name: documents/docs.cloud.google.com/iam/docs/workload-identity-federation-custom-constraints
uri: https://docs.cloud.google.com/iam/docs/workload-identity-federation-custom-constraints
title: Use custom organization policies for Workload Identity Federation
description: How to use custom organization policies for Workload Identity Federation.
...
The following example creates a custom constraint and policy that requires all new workload identity pool providers in a specific project to be SAML providers.
