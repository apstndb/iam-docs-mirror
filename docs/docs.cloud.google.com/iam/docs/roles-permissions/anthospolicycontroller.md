...
<tbody>
<tr class="odd">
<td><h4 id="anthospolicycontroller.serviceAgent" class="role-title add-link" data-text="Anthos Policy Controller Service Agent" tabindex="-1">Anthos Policy Controller Service Agent</h4>
<p>( <code dir="ltr" translate="no">roles/  anthospolicycontroller.serviceAgent</code> )</p>
