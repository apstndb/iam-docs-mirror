---
name: documents/docs.cloud.google.com/iam/docs/overview
uri: https://docs.cloud.google.com/iam/docs/overview
title: IAM overview
description: How {{dynamic_data.site_values.cloud_name}}'s Identity and Access Management (IAM) system works and how you can use it to manage access in {{dynamic_data.site_values.cloud_name_short}}.
...
![An allow policy with two role bindings. The role bindings associate specific principals with specific roles.](https://docs.cloud.google.com/static/iam/img/iam-overview-basics.svg)
