---
name: documents/docs.cloud.google.com/iam/docs/review-security-insights
uri: https://docs.cloud.google.com/iam/docs/review-security-insights
title: Review security insights
description: Review identity risks on the security insights dashboard from the {{dynamic_data.site_values.cloud_name_short}} console console.
...
For more information, see [Review and manage identity risks](https://docs.cloud.google.com/policy-intelligence/docs/manage-identity-risks) .
