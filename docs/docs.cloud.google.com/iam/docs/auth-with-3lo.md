---
name: documents/docs.cloud.google.com/iam/docs/auth-with-3lo
uri: https://docs.cloud.google.com/iam/docs/auth-with-3lo
...
5.  [Verify that you have the roles required to complete this task](https://docs.cloud.google.com/iam/docs/auth-with-3lo#req-roles) .
