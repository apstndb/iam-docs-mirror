...
8.  To edit the policy's [enforcement version](https://docs.cloud.google.com/iam/docs/principal-access-boundary-policies#blocked-permissions) , click the **Enforcement version** list and choose a new value.
