...
4.  Obtain the **API key** from the third-party service that you want to connect to.
...
1.  Create the auth provider:
        ...
        gcloud alpha agent-identity connectors create AUTH_PROVIDER_NAME \    --location="LOCATION" \    --api-key="API_KEY"
